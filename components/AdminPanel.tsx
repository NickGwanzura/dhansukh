...
const HeroManager: React.FC<{
  ...
  return (
    <div className="space-y-8 animate-fade-in max-w-4xl text-gray-dark">
      ...
      <div className="bg-white p-8 md:p-10 rounded-[2rem] shadow-airbnb border border-gray-100">
        <MediaLibrary 
          label="Hero Slider Collection"
          images={state.heroImages}
          onUpdate={onUpdateHeroImages}
        />
        <div className="mt-8 p-6 bg-gray-bg rounded-2xl border border-gray-100 flex items-start gap-4">
